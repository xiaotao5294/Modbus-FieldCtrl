...
- Every newly added or modified code block must include detailed comments so first-time readers can understand intent and flow at a glance.
- Every newly added or modified function, variable, macro, and non-trivial statement must be commented.
